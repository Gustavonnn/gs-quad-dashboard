import { useIAAlertas, resolveAlerta } from '../hooks/useSupabaseData'
      ...
      {loading && (
        <div className="flex items-center justify-center py-20">
          <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-gs-red text-[10px] font-mono tracking-widest uppercase font-bold animate-pulse">Carregando alertas do radar...</span>
          </div>
        </div>
      )}
